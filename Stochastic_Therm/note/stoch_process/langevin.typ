...
#definition("Underdamped Langevin Equation")[
  ...
  $
    dv(ph,t) &= - gamma/m ph(x,t) + F(xh,t) + sqrt((2 gamma kb T)/m) wn  \
    dv(xh,t) &= ph(x,t)/m
  $
